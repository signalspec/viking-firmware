...
## Installation
 ...
 1. Download the RP2040 Pico `.uf2` release from the [releases page](https://github.com/signalspec/viking-firmware/releases).
 2. Enter the Pico's bootloader mode by holding the "BOOTSEL" button while plugging it into USB.
 3. The Pico should appear as a USB mass storage device. Copy the `.uf2` file to the device to flash the firmware. Alternatively, flash with `picotool load viking-firmware-rp2040-pico.uf2 && picotool reboot`.
